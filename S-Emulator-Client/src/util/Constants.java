...
public class Constants {
    ...
    public final static int REFRESH_RATE = 500; // 500ms recommended polling rate
    ...
    public final static String EXECUTION_HISTORY = FULL_SERVER_PATH + "/executionHistory";
    public final static String EXECUTION_DETAILS = FULL_SERVER_PATH + "/executionDetails";
